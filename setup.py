...
setup(
    ...
    description="Python module for simplifying common patterns and class for interactgen-py, interactovery-py, "
                "and interactilogue-py modules.",
    long_description=open('README.md').read(),
    long_description_content_type="text/markdown",
    url="https://github.com/sitinc/interacticore-py",
    license="MIT",
    keywords="nlp llm utterances",
